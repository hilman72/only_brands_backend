exports.up = function (knex, Promise) {
    return knex.schema
        ...
        .then(() => {
            return knex.schema.createTable("users_recommendations", (recommendations) => {
        ...
        .then(() => {
            return knex.schema.createTable("business_coupons", (bus_coup) => {
                ...
                bus_coup.datetime("finished_date");
                ...
                bus_coup.foreign("account_business_id").references("accounts_businesses.id")
            });
        })
        .then(() => {
            return knex.schema.createTable("referal_coupons", (ref_coup) => {
                ...
                ref_coup.datetime("finished_date");
                ...
                ref_coup.foreign("business_coupon_id").references("business_coupons.id")
